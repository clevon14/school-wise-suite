...
export function AddTeacherDialog({ children }: { children: React.ReactNode }) {
  ...
  const createTeacher = useMutation({
    mutationFn: async (values: TeacherFormValues) => {
      ...
      let resignation_letter_url = null;
      let other_documents_url = null;
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="B.Ed., M.A." {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
            ...
            <div className="space-y-4 border rounded-lg p-4 bg-muted/30">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <FormField
                  ...
                  render={({ field: { value, onChange, ...field } }) => (
                    <FormItem>
                      <FormLabel>2. Joining Letter</FormLabel>
                      <FormControl>
                        <div className="border-2 border-dashed rounded-lg p-4 text-center hover:border-primary/50 transition-colors">
                          <Input
                            type="file"
                            ...
                            id="joining-upload"
                          />
                          <label htmlFor="joining-upload" className="cursor-pointer flex flex-col items-center gap-2">
                            <Upload className="h-8 w-8 text-muted-foreground" />
                            <span className="text-sm text-muted-foreground">
                              Drag and drop a file here or click
                            </span>
                ...
                <FormField
                  ...
                  render={({ field: { value, onChange, ...field } }) => (
                    <FormItem>
                      <FormLabel>3. Resignation Letter</FormLabel>
                      <FormControl>
                        <div className="border-2 border-dashed rounded-lg p-4 text-center hover:border-primary/50 transition-colors">
                          <Input
                            type="file"
                          ...
                          />
                          <label htmlFor="resignation-upload" className="cursor-pointer flex flex-col items-center gap-2">
                            <Upload className="h-8 w-8 text-muted-foreground" />
                            <span className="text-sm text-muted-foreground">
                              Drag and drop a file here or click
                            </span>
                ...
                <FormField
                  ...
                  render={({ field: { value, onChange, ...field } }) => (
                    <FormItem>
                      <FormLabel>4. Other Documents</FormLabel>
                      <FormControl>
                        <div className="border-2 border-dashed rounded-lg p-4 text-center hover:border-primary/50 transition-colors">
                          <Input
                            type="file"
                            ...
                            id="other-upload"
                          />
                          <label htmlFor="other-upload" className="cursor-pointer flex flex-col items-center gap-2">
                            <Upload className="h-8 w-8 text-muted-foreground" />
                            <span className="text-sm text-muted-foreground">
                              Drag and drop a file here or click
                            </span>
            ...
            <div className="flex justify-end gap-2 pt-4 border-t">
              ...
              <Button type="submit" disabled={createTeacher.isPending || uploading}>
                {uploading ? "Uploading..." : createTeacher.isPending ? "Adding..." : "Add Staff"}
              </Button>
            </div>
          </form>
        </Form>
